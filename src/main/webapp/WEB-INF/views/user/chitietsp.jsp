								...
								<div class="tab-content produc_tab_c">
									<div class="tab-pane fade show active" id="p_tab1"
										...
										<div class="modal_img">
											...
											<div class="view_img">
												<a class="large_view"
													href="user/assets/img/product/product13.jpg"><i
									...
									<div class="tab-pane fade" id="p_tab2" role="tabpanel">
										<div class="modal_img">
											...
											<div class="view_img">
												<a class="large_view" href="assets\img\product\product9.jpg"><i
													class="fa fa-search-plus"></i></a>
											</div>
										</div>
									</div>
									<div class="tab-pane fade" id="p_tab3" role="tabpanel">
										<div class="modal_img">
											...
											<div class="view_img">
												<a class="large_view"
													href="user/assets/img/product/product15.jpg"> <i
													class="fa fa-search-plus"></i></a>
											</div>
										</div>
									</div>
							...
							<div class="product_d_right">
								...
								<div class="product_desc">
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing
										elit. Obcaecati modi culpa voluptates illo, quos magni totam
								...
								<div class="product_d_size mb-20">
									<label for="group_1">size</label> <select name="size"
										id="group_1">
								...
								<div class="sidebar_widget color">
									...
									<div class="widget_color">
										<ul>
											<li><input type="radio" name="color"> <label
												for="color1"><a href="#">Xanh</a></label></li>
											<li><input type="radio" name="color"> <label
												for="color2"><a href="#">Vàng</a></label></li>
											<li><input type="radio" name="color"> <label
												for="color3"><a href="#">Hồng</a></label></li>
											<li><input type="radio" name="color"> <label
												for="color4"><a href="#">Xanh lá cây</a></label></li>
										</ul>
									</div>
								</div>
