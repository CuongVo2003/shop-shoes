							...
							<div class="switcher">
								<ul>
									<li class="languages"><a href="#"><img
											src="/user/assets/img/logo/fontlogo3.png" alt=""> VietNam <i
											class="fa fa-angle-down"></i></a>
										<ul class="dropdown_languages">
											<li><a href="#"><img
													src="/user/assets/img/logo/fontlogo.jpg" alt=""> English</a></li>
											<li><a href="#"><img
													src="/user/assets/img/logo/fontlogo3.png" alt=""> VietNam </a></li>
										</ul></li>
						...
						<div class="col-lg-6 col-md-6">
							<div class="header_links">
								<ul>
									...
									<li><a href="wishlist.html" title="wishlist">Sản Phẩm Yêu Thích</a></li>
				...
				<div class="header_middel">
					<div class="row align-items-center">
						...
						<div class="col-lg-3 col-md-3">
							<div class="logo">
								<a href="index.html"><img src="/user/assets/img/logo/logo.png"
									alt=""></a>
							</div>
						</div>
						<!--logo end-->
